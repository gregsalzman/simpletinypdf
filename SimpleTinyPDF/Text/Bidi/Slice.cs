...
namespace SimpleTinyPDF.Text
{
    ...
    public struct Slice<T> : IEnumerable<T>, System.Collections.IEnumerable
    {
        ...
        // Note: the original RichTextKit Slice<T> exposed an AsSpan() method;
        // it is omitted here because it would require the System.Memory
        // package and SimpleTinyPDF is dependency-free.
    }
}
